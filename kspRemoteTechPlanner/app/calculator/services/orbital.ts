...
module App.Calculator {
    ...
    export function hohmannStartDeltaV(bodyRadius: number, altitude1: number, altitude2: number, stdGravParam: number) {
    ...
    export function hohmannFinishDeltaV(bodyRadius: number, altitude1: number, altitude2: number, stdGravParam: number) {
        var r1: number = bodyRadius + altitude1;
        var r2: number = bodyRadius + altitude2;
